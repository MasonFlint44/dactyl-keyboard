...
class CarbonfetCluster(DefaultCluster):
    ...
    def get_config(self):
        with open(
            os.path.join("src", "clusters", "json", "CARBONFET.json"), mode="r"
        ) as fid:
            data = json.load(fid)
    ...
    def thumb_15x_layout(self, shape, cap=False, plate=True):
        ...
        if plate:
            ...
            return union([self.bl_place(shape), self.ml_place(shape)])
    ...
    def connection(self, side="right"):
        ...
        shape = bottom_hull(
            [
                left_key_place(
                    translate(web_post(), wall_locate2(-1, 0)),
                    cornerrow,
                    -1,
                    low_corner=True,
                    side=side,
                ...
                left_key_place(
                    translate(web_post(), wall_locate3(-1, 0)),
                    cornerrow,
                    -1,
                    low_corner=True,
                    side=side,
            ...
            [
                ...
                hull_from_shapes(
                    [
                        ...
                        self.bl_place(
                            translate(self.thumb_post_tr(), wall_locate2(-0.3, 1))
                        ),
                        self.bl_place(
                            translate(self.thumb_post_tr(), wall_locate3(-0.3, 1))
                        ),
                        self.ml_place(self.thumb_post_tl()),
                    ]
                ),
        ...
        shape = union(
            [
                ...
                hull_from_shapes(
                    [
                        left_key_place(
                            web_post(), cornerrow, -1, low_corner=True, side=side
                        ),
                        left_key_place(
                            translate(web_post(), wall_locate1(-1, 0)),
                            cornerrow,
                            -1,
                            low_corner=True,
                            side=side,
            ...
            [
                ...
                hull_from_shapes(
                    [
                        self.bl_place(self.thumb_post_tr()),
                        self.bl_place(
                            translate(self.thumb_post_tr(), wall_locate1(-0.3, 1))
                        ),
                        self.bl_place(
                            translate(self.thumb_post_tr(), wall_locate2(-0.3, 1))
                        ),
